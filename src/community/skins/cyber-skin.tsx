...
export const getCyberSkin = (): Skin => {
    const skin: Skin = {
        ...
        colors: {
            ...
            backgroundSelected: applyAlpha(palette.brand, 0.15),
            backgroundSelectedHover: applyAlpha(palette.brand, 0.2),
            backgroundSelectedPressed: applyAlpha(palette.brand, 0.25),
            backgroundSelectedBrand: palette.brand10,
            backgroundSelectedBrandHover: palette.brand15,
            backgroundSelectedBrandPressed: palette.brand15,
            backgroundSelectedNegative: applyAlpha(palette.white, 0.1),
            backgroundSelectedNegativeHover: applyAlpha(palette.white, 0.12),
            backgroundSelectedNegativePressed: applyAlpha(palette.white, 0.15),
            ...
            buttonLinkNeutralBackgroundPressed: palette.brand10,
            buttonLinkNeutralBackgroundBrand: applyAlpha(palette.white, 0.08),
            buttonLinkNeutralBackgroundBrandPressed: applyAlpha(palette.white, 0.12),
            buttonLinkNeutralBackgroundNegative: applyAlpha(palette.white, 0.08),
            buttonLinkNeutralBackgroundNegativePressed: applyAlpha(palette.white, 0.12),
            buttonLinkNeutralBackgroundMedia: applyAlpha(palette.white, 0.08),
            buttonLinkNeutralBackgroundMediaPressed: applyAlpha(palette.white, 0.12),
            ...
            textLinkNeutral: palette.black,
            textLinkNeutralBrand: palette.white,
            textLinkNeutralNegative: palette.white,
            textLinkNeutralAlternative: palette.grey500,
